...
export default class AccountSubscription extends BaseResource {
  ...
  create(body: SimpleSchemaTypes.AccountSubscriptionCreateSchema) {
    return this.rawCreate(
      serializeRequestBody<SchemaTypes.AccountSubscriptionCreateSchema>({
        body,
        type: AccountSubscription.TYPE,
      }),
    ).then((body) =>
      deserializeResponseBody<SimpleSchemaTypes.AccountSubscriptionCreateTargetSchema>(
        body,
      ),
    );
  }
  ...
  simulate(body: SimpleSchemaTypes.AccountSubscriptionSimulateSchema) {
    return this.rawSimulate(
      serializeRequestBody<SchemaTypes.AccountSubscriptionSimulateSchema>({
        body,
        type: AccountSubscription.TYPE,
      }),
    ).then((body) =>
      deserializeResponseBody<SimpleSchemaTypes.AccountSubscriptionSimulateTargetSchema>(
        body,
      ),
    );
  }
  ...
  validate(body: SimpleSchemaTypes.AccountSubscriptionValidateSchema) {
    return this.rawValidate(
      serializeRequestBody<SchemaTypes.AccountSubscriptionValidateSchema>({
        body,
        type: AccountSubscription.TYPE,
      }),
    ).then((body) =>
      deserializeResponseBody<SimpleSchemaTypes.AccountSubscriptionValidateTargetSchema>(
        body,
      ),
    );
  }
